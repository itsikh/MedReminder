...
import com.itsikh.medreminder.ui.components.SettingsScaffold
                ...
                Card(modifier = Modifier.fillMaxWidth()) {
                    Row(
                        ...
                        Column(Modifier.weight(1f)) {
                            Text("Snooze & Location", style = MaterialTheme.typography.bodyLarge)
                            Text(
                                "Customize snooze durations and set home location for location-based snooze",
