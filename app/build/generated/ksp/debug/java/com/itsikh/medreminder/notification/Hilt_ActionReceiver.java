...
public abstract class Hilt_ActionReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((ActionReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectActionReceiver(UnsafeCasts.<ActionReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
